...
//路由处理函数
const { createuser_func, namelogin_func , phonelogin_func, getCode_func } = require('../router_hendler/user')
const { inquirerep_func , inqcomment_func} = require('../inquirerep/index')
//规则
const { createuser_schema , namelogin_schema, phonelogin_schema, code_schema } = require('../schema/user')
